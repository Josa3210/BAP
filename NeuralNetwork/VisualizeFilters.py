...
if __name__ == '__main__':
    ...
    dataset = FootstepDataset(path, transform=filterExtr, labelFilter=participants, cachePath=utils.getDataRoot().joinpath(r"cache\TKEO441"))
    ...
    model = NeuralNetworkTKEO2(5, dataset.featureSize)
    model.loadModel(utils.getDataRoot().joinpath("models/NeuralNetworkTKEO-new411test2.pth"))
    model.eval()
